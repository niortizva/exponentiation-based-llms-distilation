...
\author{Nicolas Ortiz Valencia, \\ Ruben Dario Hernandez Beleño,\\ Mario Aldape Pérez}
\date{}

\maketitle

\input{sections/Introduction}
\input{sections/Background_and_rationale}
\input{sections/Proposed_Methodology}
\input{sections/NSEA}
\input{sections/conclussion__and_future_directions}
